...
def replace_and_print(func, *args):
...
def open_browser(browser_name):
    actual_result = replace_and_print(open_browser, browser_name)
...
def find_registration_button_on_login_page(page_url, button_text):
    actual_result = replace_and_print(find_registration_button_on_login_page, page_url, button_text)
